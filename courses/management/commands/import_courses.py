...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for index, row in df.iterrows():
            ...
            # Clear existing fields for the course
            course.days = None
            course.days_2 = None
            ...
            if len(class_matches) > 0:
                ...
                if len(class_matches) > 1:
                    ...
                    course.days_2 = day_chars_2

            course.save()
            print(" - Course '%s' updated with days and times." % row['Title'])

        print('Successfully imported courses with days and times.')
